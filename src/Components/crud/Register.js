            ...
            <div className='register'>
                ...
                <form method="POST" className="formRegister text-center border border-dark p-3 rounded" onSubmit={register}>
                    ...
                    <div className="mb-1">
                        ...
                        <input onChange={handleChangePassword} type="password" className="form-control" id="mdp" name="mdp" autoComplete="off" />
                    </div>
                    <button className="btn btn-dark mt-1" type="submit" value="Confirmer l'inscription">Confirmer l'inscription</button>
                </form>
            </div>
        </section>
    );
